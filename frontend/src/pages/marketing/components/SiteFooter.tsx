 ...
 * visitor. Dark, matching the rest of the marketing page — see index.css
 * for why the marketing surface commits to one tone instead of switching
 * mid-page.
 */
      ...
      <div className="mx-auto max-w-5xl px-6 py-10">
        <div className="flex flex-col gap-6 sm:flex-row sm:items-start sm:justify-between">
          <div className="max-w-md">
            <p className="text-sm font-semibold text-ink-foreground">SIH26139</p>
        ...
        <p className="mt-8 border-t border-ink-border pt-6 text-xs text-ink-muted">
